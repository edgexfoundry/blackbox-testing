...
export supportNotifications=nexus3.edgexfoundry.org:10004/docker-support-notifications-arm64
export supportScheduler=nexus3.edgexfoundry.org:10004/docker-support-scheduler-arm64
export supportRulesengine=nexus3.edgexfoundry.org:10004/docker-support-rulesengine-arm64
